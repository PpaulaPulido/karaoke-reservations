...
```
java -Dspring.profiles.active=production -jar ./target/karaoke-reservations-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.karaoke/karaoke-reservations
```
